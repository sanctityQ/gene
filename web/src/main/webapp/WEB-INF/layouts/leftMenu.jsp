...
<div class="easyui-accordion">
	<div title="订单管理" data-options="iconCls:'order'" style="height:200px;">
		<ul class="sbu_menu">
			...
			<li url="importError.html" id="orderInfo"><i class="icon-file-text"></i>订单信息</li>
	...
	<div title="安排合成" data-options="iconCls:'compound'" style="height:200px;">
		<ul class="sbu_menu">
			<li url="orderImport.html" id="syntheticPlate"><i class="icon-keyboard"></i>制作合成板</li>
	...
	<div title="业务员管理" data-options="iconCls:'salesman'" style="height:200px;">
		<ul class="sbu_menu">
			<li url="${ctx}/user/prepareManageQuery" id="userManage"><i class="icon-cogs"></i>业务员管理</li>
		</ul>
	</div>
