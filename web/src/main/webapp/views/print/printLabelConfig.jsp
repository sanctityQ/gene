...
<body>
	...
	<form id="inputForm" action="${ctx}/print/saveLabelConfig/" method="post" class="form-horizontal">
		<fieldset>
			...
			<div class="control-group">
				<div class="controls">
				    ...
				    <label for="loginName" class="control-label">打印列数:</label>
					<input type="text" id="productNo" name="productNo" size="20" value="" class="required"/>
				</div>
				<div class="controls">
     				<label for="loginName" class="control-label">生产编号开头:</label>
					<input type="text" id="boardNo" name="boardNo" size="20" value="" class="required"/>
				</div>				
				<div class="controls">
        			<input id="submit" class="btn btn-primary" type="submit" value="确定" />
				</div>						
			</div>
		</fieldset>
	</form>
