...
<div class="tools_bar tabbing">
    <button class="btn" onclick="goToPage('views/synthesis/bakeResults.jsp');" type="">取 消</button>
    <button class="btn btn-primary" onclick="saveBoard('bake');" type="">保 存</button>
</div>
