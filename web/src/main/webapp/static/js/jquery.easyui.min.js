...
},beforePageText:"当前",afterPageText:"共 {pages} 页",displayMsg:"每页 {from} 至 {to} 条， 总计 {total} 条",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"必填字段.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,tipOptions:{showEvent:"none",hideEvent:"none",showDelay:0,hideDelay:0,zIndex:"",onShow:function(){
$(this).tooltip("tip").css({color:"#fff",borderColor:"#fff",backgroundColor:"#000"});
},onHide:function(){
$(this).tooltip("destroy");
...
},message:"请输入正确的Email地址."},url:{validator:function(_443){
...
},message:"请输入正确的 URL地址."},length:{validator:function(_444,_445){
var len=$.trim(_444).length;
return len>=_445[0]&&len<=_445[1];
},message:"需输入 {0} 至 {1}个字符."},remote:{validator:function(_446,_447){
var data={};
data[_447[1]]=_446;
...
_932(this,q);
}},currentText:"今天",closeText:"取消",okText:"确定",buttons:[{text:function(_945){
...
if(!_94b.spinner){
var p=$("<div class=\"datebox-time\" style=\"padding:2px 0 3px\"><input style=\"width:170px\"></div>").insertAfter(_94d.children("div.datebox-calendar-inner"));
